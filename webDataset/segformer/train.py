...
# model.py re-exports ArcheoModel from PADS/segformer/model.py and, as a side
# effect, adds PADS/segformer to sys.path -- reuse that for GPUUtilMonitor too
...
def main():
    ...
    os.makedirs(os.path.join(PROJECT_ROOT, "webDataset", "segformer", "logs"), exist_ok=True)
