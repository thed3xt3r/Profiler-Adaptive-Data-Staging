"""Re-exports the real ArcheoModel from PADS/segformer/model.py instead of
...
instead of PADS/segformer/model.py -- a self-import, not the intended one.
"""
...
# model.py; put PADS/segformer on sys.path too so that plain import finds it.
