...
# model.py re-exports ArcheoModel from PADS/deeplab/model.py and, as a side
# effect, adds PADS/deeplab to sys.path -- reuse that for GPUUtilMonitor too
...
def main():
    ...
    os.makedirs(os.path.join(PROJECT_ROOT, "webDataset", "deeplab", "logs"), exist_ok=True)
