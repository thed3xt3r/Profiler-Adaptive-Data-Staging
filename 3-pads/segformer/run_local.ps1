<#
.SYNOPSIS
    Local Windows/NVIDIA launcher for the PADS SegFormer run.

.DESCRIPTION
    The Windows counterpart to PAD_segformer.slurm. There is no scheduler and no
    ...
    an effective batch of 32, matching the cluster runs. SegFormer-B0 is the
    lightest of the three models, so -BatchSize 8 -Accumulate 4 usually fits too.

.EXAMPLE
    .\run_local.ps1
    .\run_local.ps1 -Mode standard -Epochs 20
    .\run_local.ps1 -BatchSize 8 -Accumulate 4
#>
[CmdletBinding()]
param(
...
$LogDir   = Join-Path $OutRoot "segformer\logs"
...
Write-Output "============================================================"
Write-Output "SegFormer Training - SegFormer B0"
