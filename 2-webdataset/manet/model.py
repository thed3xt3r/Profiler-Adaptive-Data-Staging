"""Re-exports the real ArcheoModel from 3-pads/manet/model.py instead of
...
instead of 3-pads/manet/model.py -- a self-import, not the intended one.
"""
...
# alongside the real model.py; put 3-pads/manet on sys.path too so that plain
# import finds them.
