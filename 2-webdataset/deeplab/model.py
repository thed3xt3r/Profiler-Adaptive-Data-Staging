"""Re-exports the real ArcheoModel from 3-pads/deeplab/model.py instead of
...
instead of 3-pads/deeplab/model.py -- a self-import, not the intended one.
"""
...
# model.py; put 3-pads/deeplab on sys.path too so that plain import finds it.
