...
configuration tested for two of three architectures. \pads{}'s adaptive policy
selection, however, invoked staging in only a small minority of the configurations
where it was measurably available to do so, traced to a specific, quantified defect
in the profiler's own warm-up measurement -- one-time GPU initialisation cost
dominating a short averaging window and systematically understating the true
data-to-compute time ratio by roughly an order of magnitude -- rather than to a
failure of the staging mechanism itself. A validated correction, discarding warm-up
