...
\begin{description}
  ...
  \item[RQ3 - Does predictive staging outperform fixed streaming?]
    ...
    profiler rather than a limitation of the staging mechanism itself; a benefit
    is observed when that mechanism is actually invoked
    (Table~\ref{tab:ablation-components}).
