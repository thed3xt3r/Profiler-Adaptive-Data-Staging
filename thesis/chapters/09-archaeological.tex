%% ============================================================================
\section{Archaeological Contributions and Limitations}
\label{ch:archaeology}
%% ============================================================================

This thesis is an engineering contribution: it concerns how training data
...
This section answers that in plain terms. Technical vocabulary is defined where
...
\subsection{Transfer to other regions}
\label{sec:arch-regions}

\paragraph{The short answer.}
A model trained on tells in the southern Mesopotamian floodplain will not work
well elsewhere without being shown local examples first. It is, however,
comparatively cheap to adapt, and adaptation to a nearby region has already
been demonstrated by others using the same underlying model.

\paragraph{Why a trained model does not simply transfer.}
...
\paragraph{Why adaptation is nonetheless cheap.}
...
\paragraph{What actually limits adaptation.}
...
\subsection{Transfer to other kinds of structure}
\label{sec:arch-structures}

\paragraph{The short answer.}
Yes, and this is better established than regional transfer. Nothing in the
method is specific to mounded settlements.
...
\paragraph{What makes a feature easy or hard.}
...
\subsection{How reliable are these findings?}
\label{sec:arch-reliability}

This subsection concerns the accuracy figures. It is the part of this section
most likely to matter to a reviewer, and it contains a caveat that is easy to
miss when reading the headline number.

\paragraph{What the headline number means, and what it does not.}
...
\paragraph{The per-site picture.}
...
\paragraph{Reliability of the engineering findings.}
...
\subsection{How the findings were verified}
...
\paragraph{What none of this establishes.}
...
\subsection{Can archaeological features be mistaken for other features?}
\label{sec:arch-confusion}

Yes, in both directions, and this thesis can quantify how often.

\paragraph{Mistaking something else for a site.}
...
\paragraph{Missing a site that is present.}
...
\paragraph{The ambiguity is not only the model's.}
...
\paragraph{Why this argues for expert review rather than against the method.}
...
\subsection{What this thesis contributes archaeologically}
...
addressing this raises accelerator utilisation substantially
