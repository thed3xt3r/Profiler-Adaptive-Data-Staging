...
(\code{num\_workers=4}, \code{pin\_memory=True}). Section~\ref{ch:results},
Table~\ref{tab:rq1-loader-util} reports the same underlying runs.
...
Luxembourg, on GPU nodes equipped with NVIDIA V100 GPUs, scheduled via
Slurm.
