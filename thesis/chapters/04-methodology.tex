...
This chapter defines \pads{}, its measured signals, decision rules, staging
policies, and the protocol used to evaluate them. It follows the workload
characterisation in Section~\ref{ch:materials} and supplies the mechanisms tested
in Sections~\ref{ch:results} and~\ref{ch:ablation}.
