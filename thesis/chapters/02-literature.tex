...
Both are relevant to Section~\ref{sec:ablation-input}'s CORONA input variant: they
confirm that CORONA-based detection is an established, independently replicated
task, not a peculiarity of this dataset, though neither paper reports the
per-file storage cost of the imagery, which is this thesis's specific concern
with it.
...
A separate and smaller literature is concerned with whether the accelerator is
