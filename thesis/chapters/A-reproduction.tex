...
\code{casini\_reference}, was built independently of both the workstation port
...
Both are properties of \code{PADS/*/model.py} and \code{PADS/*/dataset.py}
specifically, not of this appendix's already-faithful port or of
\code{casini\_reference}; neither pipeline used to produce
